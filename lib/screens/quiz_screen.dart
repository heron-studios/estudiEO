    ...
    if (!_isLoaded) {
      return Scaffold(
        ...
        body: NeuralBackgroundWrapper(
          child: const Center(child: CircularProgressIndicator(color: NeuralDesignSystem.blueGoogle)),
        ),
      );
    }
                        ...
                        ...List.generate(question.options.length, (i) {
                          ...
                          if (isAnswered) {
                            if (i == question.correctAnswer) {
                              ...
                              trailing = Icon(Icons.cancel, color: NeuralDesignSystem.pink, size: 22);
                            }
