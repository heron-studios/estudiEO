...
final Map<String, Topic> comunicacionTopics = {
  'com_t1': Topic(
    ...
    description:
        'Grafias, acentuacion, mayusculas, signos de puntuacion y concurrencia vocalica.',
    questionCount: 158,
  ),
  'com_t2': Topic(
    id: 'com_t2',
    ...
    description:
        'Sujeto, predicado, complementos, categorias gramaticales y oraciones simples o compuestas.',
    questionCount: 154,
  ),
  'com_t3': Topic(
    id: 'com_t3',
    ...
    name: '3. La Narracion',
    description:
        'Estructura narrativa, narrador, personajes, tiempo, espacio y especies narrativas.',
    questionCount: 152,
  ),
  'com_t4': Topic(
    id: 'com_t4',
    ...
    description:
        'Autores, obras, etapas literarias, figuras y movimientos de la literatura peruana.',
    questionCount: 154,
  ),
};
