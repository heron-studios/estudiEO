...
final List<Question> reglasOrtograficasQuestions = [
  ...
  Question(
    ...
    text:
        r'''Según las reglas generales de acentuación y ortografía, ¿cuál de las siguientes opciones presenta una palabra correctamente escrita y que constituye una excepción a la regla de los verbos terminados en "-bir"?''',
    options: [
      r'''Prohivir''',
      r'''Hervir''',
      r'''Sucumbir''',
    ...
    correctAnswer: 1,
    explanation:
        r'''La regla ortográfica indica que los verbos terminados en "-bir" se escriben con "b" (como concebir, sucumbir, recibir), siendo las únicas tres excepciones en el español los verbos "hervir", "servir" y "vivir".''',
  ),
  ...
  Question(
    ...
    topicId: 'eo_pnp_reglas_ortograficas_01',
    text:
        r'''De acuerdo con la normativa vigente de la RAE respecto al alfabeto español, ¿cuál es la afirmación correcta?''',
    options: [
    ...
    correctAnswer: 2,
    explanation:
        r'''En 2010, la RAE eliminó oficialmente la "ch" y la "ll" del alfabeto al considerarlos dígrafos (conjunto de dos letras que representan un solo fonema), reduciendo el abecedario a 27 letras. Además, las mayúsculas siempre se tildan y la "y" se denomina "ye".''',
  ),
  ...
  Question(
    ...
    topicId: 'eo_pnp_reglas_ortograficas_01',
    text:
        r'''Identifique la oración que presenta un uso correcto de la tilde diacrítica según las normas vigentes de la RAE.''',
    options: [
    ...
    correctAnswer: 1,
    explanation:
        r'''"Él" (pronombre) y "té" (bebida) llevan tilde diacrítica, mientras que los pronombres átonos "te" y "ti" nunca llevan tilde. "Dio" es un monosílabo que jamás se tilda.''',
  ),
  ...
  Question(
    ...
    topicId: 'eo_pnp_reglas_ortograficas_01',
    text:
        r'''¿En qué oración se ha aplicado correctamente la normativa de la RAE respecto a la conjunción "o" y los adverbios de tiempo/inclusión?''',
    options: [
    ...
    correctAnswer: 3,
    explanation:
        r'''La conjunción "o" entre números ya no lleva tilde (5 o 6). "Aún" lleva tilde porque equivale a "todavía". Las opciones B y C confunden los usos de "aún/aun".''',
  ),
  ...
  Question(
    ...
    topicId: 'eo_pnp_reglas_ortograficas_01',
    text:
        r'''Basándose en las reformas ortográficas de la RAE de 2010 respecto al uso de prefijos y acentuación, señale la oración correcta.''',
    options: [
    ...
    correctAnswer: 1,
    explanation:
        r'''El prefijo "ex" se escribe separado porque la base léxica es pluriverbal ("primer ministro"). "Este" (demostrativo) no lleva tilde por norma general. La A, C y D fallan en la escritura del prefijo "ex" o en la tildación injustificada de "sólo" y "aquél/ése".''',
  ),
  ...
  Question(
    ...
    topicId: 'eo_pnp_reglas_ortograficas_01',
    text:
        r'''Identifique la oración que emplea correctamente la normativa sobre palabras terminadas en "-mente" y monosílabos.''',
    options: [
    ...
    correctAnswer: 2,
    explanation:
        r'''"Sutilmente" no lleva tilde porque "sutil" no la lleva (aguda terminada en l). "Mas" está correctamente usado sin tilde al equivaler a "pero". Las otras opciones fallan al tildar monosílabos que nunca se tildan ("vió", "dió", "fué") o fallan en las reglas de "-mente" (rápidamente sí lleva) o el prefijo "ex-".''',
  ),
  ...
  Question(
    ...
    topicId: 'eo_pnp_reglas_ortograficas_01',
    text:
        r'''Considere las reglas de acentuación en palabras terminadas en doble consonante y en monosílabos con diptongos ortográficos. ¿Qué oración está escrita con impecable rigor ortográfico según la RAE?''',
    options: [
    ...
    correctAnswer: 0,
    explanation:
        r""""Bíceps" se tilda porque es grave terminada en 's' precedida de consonante. "Robots" no se tilda porque es aguda terminada en 's' precedida de consonante. La opción B y D tildan "truhán", "guión" e "ión", lo cual es incorrecto porque son monosílabos. La opción C tilda incorrectamente "jóven" (palabra grave terminada en 'n' no se tilda). La E tilda el monosílabo "vió".""",
  ),
  ...
  Question(
    ...
    topicId: 'eo_pnp_reglas_ortograficas_01',
    text:
        r'''Con base en la tildación de palabras con pronombres enclíticos y las actualizaciones normativas de la RAE, indique la oración que presenta correcta escritura.''',
    options: [
