...
final List<Question> redesVialesQuestions = [
  ...
  Question(
    ...
    correctAnswer: 2,
    explanation: r"""La Red Vial Vecinal o Provincial une los distritos dentro de cada provincia, está a cargo de los gobiernos locales (municipalidades), sus mapas y postes usan el color verde, y su numeración obligatoria inicia a partir del número 500.""",
  ),

  Question(
    id: "pfrh_rv_easy_2",
    topicId: "cs_t5",
    text: r"""El Estado peruano delega competencias sobre el Sistema Nacional de Carreteras a diferentes entidades. ¿Qué organismo es el responsable exclusivo del planeamiento, operación y administración de la Red Vial Nacional, incluso si sus rutas atraviesan áreas urbanas?""",
    options: [
    ...
    correctAnswer: 3,
    explanation: r"""La normativa especifica que el MTC es la autoridad competente a cargo de la infraestructura de la Red Vial Nacional de manera exclusiva, incluso en los tramos donde estas carreteras de escala nacional atraviesan zonas urbanas.""",
  ),
  ...
  Question(
    id: "pfrh_rv_medium_1",
    topicId: "cs_t5",
    text: r"""Como policía de carreteras, es indispensable dominar la codificación del Sistema Nacional de Carreteras (SINAC) para la elaboración de atestados o partes por accidentes. ¿Cómo se distinguen numéricamente en la codificación nacional los "Ejes Longitudinales" frente a los "Ejes Transversales o de penetración"?""",
    options: [
    ...
    correctAnswer: 2,
    explanation: r"""El Clasificador de Rutas establece que la Red Vial Nacional identifica a sus carreteras longitudinales (norte-sur) con números impares de un dígito, y a sus ejes transversales o de penetración (oeste-este) con numeración par.""",
  ),

  Question(
    id: "pfrh_rv_medium_2",
    topicId: "cs_t5",
    text: r"""El cálculo de los recorridos viales e indemnizaciones logísticas requiere ubicar topográficamente el punto de origen de una vía. Según el MTC, ¿en qué punto geográfico exacto se ha establecido oficialmente el "Kilómetro 0" (Km 0) del Eje Longitudinal de la Selva (Ruta Nacional PE-5)?""",
    options: [
    ...
    correctAnswer: 3,
    explanation: r"""Según la estructura formal del MTC, el Km 0 de la Longitudinal de la Selva (PE-5) se encuentra fijado oficialmente en el Puente Reither, distrito de Chanchamayo, región Junín.""",
  ),
  ...
  Question(
    ...
    correctAnswer: 2,
    explanation: r"""El "Derecho de Vía" es el espacio jurídico y físico de ancho variable establecido por resolución para albergar a la carretera, resguardando el terreno para futuras ampliaciones y garantizando zonas de seguridad laterales para los usuarios.""",
  ),

  Question(
    id: "pfrh_rv_hard_2",
    topicId: "cs_t5",
    text: r"""Un Gobierno Regional solicita y obtiene una "Reclasificación Vial Temporal" de una carretera nacional en su territorio, aludiendo que tiene fondos del canon para asfaltarla. Basándose en la normativa del SINAC y el DS 015-2024-MTC, ¿cuál es la sanción legal que impone la norma si este Gobierno Regional retrasa el inicio del proyecto?""",
    options: [
    ...
    correctAnswer: 3,
    explanation: r"""El DS 015-2024-MTC estipula claramente que una reclasificación temporal caduca y queda sin efecto si transcurre más de un (1) año sin que la autoridad que la solicitó inicie o contrate las obras, debiendo devolver la ruta a su dueño correspondiente.""",
  ),
  ...
  Question(
    ...
    correctAnswer: 2,
    explanation: r"""El artículo 28 del DS 015-2024-MTC establece categóricamente que ninguna medida de restricción dictada por gobiernos subnacionales puede afectar a la Red Vial Nacional, inclusive en las áreas de travesía urbana, siendo una potestad única del MTC.""",
  ),

  Question(
    id: "pfrh_rv_extreme_2",
    topicId: "cs_t5",
    text: r"""El Sistema Nacional de Carreteras (SINAC) necesita tener su inventario de infraestructura formalizado para otorgar seguridad jurídica ante la concesión de redes viales. Según el reglamento de jerarquización vigente, ¿qué entidad gubernamental propone la actualización del "Clasificador de Rutas" y con qué frecuencia de tiempo máxima, y obligatoria, debe ser actualizado y aprobado mediante Decreto Supremo?""",
    options: [
    ...
    correctAnswer: 3,
    explanation: r"""El Clasificador de Rutas es el documento matriz del SINAC. La norma vigente determina que la DGPPT es responsable de elaborar y proponer su actualización vía Decreto Supremo cada tres (3) años, contados desde su última aprobación.""",
  ),
];
