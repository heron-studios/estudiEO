...
final List<Question> ecosistemasTecnologiaQuestions = [
  ...
  Question(
    ...
    topicId: 'cs_t4',
    text:
        r'''Según los parámetros establecidos por la Comisión Brundtland y respaldados por la ONU, ¿cuál es la definición formal y técnica del "Desarrollo Sostenible"?''',
    options: [
    ...
    correctAnswer: 2,
    explanation:
        r'''El Informe Brundtland estableció que el desarrollo sostenible no prohíbe el crecimiento económico, sino que exige que este cubra las necesidades actuales en equilibrio con el ambiente y la sociedad, garantizando que los recursos no se agoten para las futuras generaciones.''',
  ),
  ...
  Question(
    ...
    topicId: 'cs_t4',
    text:
        r'''El concepto de "tecnología sostenible" difiere radicalmente de las tecnologías convencionales por su impacto integral en la sociedad y el planeta. ¿En qué pilares fundamentales se basa su diseño y aplicación?''',
    options: [
    ...
    correctAnswer: 1,
    explanation:
        r'''La tecnología sostenible tiene como base la optimización de recursos, minimizando la contaminación mediante la eficiencia energética, la mitigación de emisiones de gases de efecto invernadero y la priorización de insumos reciclables o renovables.''',
  ),
  ...
  Question(
    ...
    topicId: 'cs_t4',
    text:
        r'''Las tecnologías ambientales modernas promueven un cambio radical en los sistemas productivos mundiales. En contraposición al modelo lineal de "extraer, producir y desechar", ¿cuál es la finalidad técnica central de la "Economía Circular"?''',
    options: [
    ...
    correctAnswer: 2,
    explanation:
        r'''La economía circular se basa en la circularidad de los materiales; busca eliminar el concepto tradicional de "basura" recuperando los desechos para reintroducirlos en la cadena de valor como nuevos insumos, preservando así el entorno.''',
  ),
  ...
  Question(
    ...
    correctAnswer: 0,
    explanation:
        r'''El ecodiseño asegura la sostenibilidad de un producto desde su fase de creación (origen), previendo que sus componentes sean fácilmente separables, recuperables y reciclables cuando ya no sean útiles.''',
  ),
  ...
  Question(
    ...
    correctAnswer: 1,
    explanation:
        r'''El IoT ha permitido el monitoreo en tiempo real del estado de los suelos, lo que facilitó a la agricultura de precisión peruana optimizar sus recursos e incrementar la eficiencia del uso del agua en un 15%, protegiendo este vital recurso.''',
  ),
  ...
  Question(
    ...
    correctAnswer: 1,
    explanation:
        r'''En ciudades como Barcelona, los contenedores inteligentes informan su nivel de capacidad en tiempo real, lo que evita que los camiones hagan recorridos innecesarios, ahorrando diésel y disminuyendo drásticamente el CO2 emitido al aire.''',
  ),
  ...
  Question(
    ...
    correctAnswer: 2,
    explanation:
        r'''El Estado peruano monitorea la deforestación amazónica cruzando información satelital a través de las ATD y sistematizando los datos operativos recolectados en campo por los guardaparques mediante la tecnología SMART, asegurando una gestión eficiente frente a las amenazas ambientales.''',
  ),
  ...
  Question(
    ...
    topicId: 'cs_t4',
    text:
        r'''El desarrollo sostenible global advierte sobre una limitante geopolítica conocida como la "brecha tecnológica". En el marco del cumplimiento de los Objetivos de Desarrollo Sostenible (como el ODS 15), ¿qué representa específicamente este concepto para naciones en vías de desarrollo como el Perú?''',
    options: [
