...
final List<Question> autoestimaAutocuidadoQuestions = [
  // ─── Nivel Fácil ───
  Question(
    id: 'pfrh_aa_f1',
    topicId: 'pfrh_autoestima_autocuidado',
    text: r'''¿Qué se entiende fundamentalmente por "autoestima"?''',
    options: [
      r'''La capacidad de memorizar conocimientos para obtener altas calificaciones en la escuela.''',
      r'''El sentimiento de superioridad que se tiene al ganar competencias deportivas.''',
      r'''La opinión y valoración emocional que una persona tiene sobre su propia valía como ser humano.''',
      r'''La cantidad de bienes materiales y popularidad que un individuo acumula en su vida.''',
  ...
  Question(
    id: 'pfrh_aa_f2',
    topicId: 'pfrh_autoestima_autocuidado',
    text: r'''¿Cuál es el concepto central del "autocuidado"?''',
    options: [
      r'''Aislarse completamente de la sociedad para evitar cualquier tipo de conflicto.''',
      r'''Delegar toda la responsabilidad de nuestra salud física exclusivamente a los médicos.''',
      r'''La práctica deliberada de hábitos diarios para mantener y mejorar nuestro bienestar físico, mental y emocional.''',
      r'''La actitud de evadir los problemas y responsabilidades académicas para descansar todo el día.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''El amor hacia uno mismo se traduce en acciones de bienestar (ME QUIERO = ME CUIDO).''',
      r'''El sufrimiento constante es la única vía para alcanzar la madurez (Dolor es ganancia).''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Mantener una dieta equilibrada, hacer ejercicio regularmente y dormir lo suficiente.''',
      r'''Leer libros de filosofía compleja para estimular el desarrollo neuronal.''',
  ...
  Question(
    id: 'pfrh_aa_f5',
    topicId: 'pfrh_autoestima_autocuidado',
    text: r'''¿Qué significa tener una "baja autoestima"?''',
    options: [
      r'''Ser una persona que siempre está feliz y nunca experimenta tristeza.''',
      r'''Sentir un orgullo exagerado y tratar de humillar a los compañeros.''',
      r'''No valorarse positivamente, sentirse insatisfecho consigo mismo y creer que no se es suficientemente bueno.''',
      r'''Poseer una inteligencia intrapersonal tan alta que no se necesita relacionarse con nadie.''',
  ...
  Question(
    id: 'pfrh_aa_f6',
    topicId: 'pfrh_autoestima_autocuidado',
    text: r'''¿Por qué se afirma que el autocuidado NO es un acto egoísta?''',
    options: [
      r'''Porque el Estado obliga legalmente a todos los ciudadanos a estar sanos.''',
      r'''Porque solo las personas con mucho dinero tienen el privilegio de cuidarse.''',
      r'''Porque proteger nuestra salud física y mental es esencial para estar bien y poder funcionar adecuadamente e, incluso, ayudar a los demás.''',
      r'''Porque al cuidarnos físicamente logramos un aspecto que intimida a nuestros enemigos.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Tomar un descanso, realizar ejercicios de respiración consciente o hacer una "pausa" para relajarse.''',
      r'''Culpar a los amigos y familiares por la presión sufrida en la escuela o el trabajo.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''A través de los mensajes, el afecto y la satisfacción de necesidades físicas y emocionales que les brindan desde la tierna infancia.''',
      r'''Exigiéndoles ser perfectos en todo momento para que la sociedad los admire.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Reduce la hormona del estrés (cortisol), libera endorfinas y fortalece el sistema inmunológico.''',
      r'''Modifica nuestra estructura ósea permanentemente haciéndonos inmunes a fracturas.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''A realizar actividades como la lectura, aprender nuevas habilidades y buscar momentos de desconexión mediante el ocio productivo.''',
      r'''A tratar a los demás con respeto para no recibir sanciones del colegio.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Como la repetición constante de muchos pequeños hábitos de cuidado personal que aseguran el bienestar emocional, físico y mental.''',
      r'''Como una habilidad innata que solo poseen las personas que nunca experimentan enfermedades graves.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Autoestima, conciencia emocional y autorregulación.''',
      r'''Memoria a corto plazo, memoria a largo plazo y velocidad de procesamiento.''',
  ...
  Question(
    id: 'pfrh_aa_m3',
    topicId: 'pfrh_autoestima_autocuidado',
    text: r'''¿Qué implica la "dimensión social" dentro del autocuidado?''',
    options: [
      r'''Asistir a fiestas todos los fines de semana sin importar el cansancio físico acumulado.''',
      r'''Intentar complacer a todas las personas en todo momento para evitar que se molesten con nosotros.''',
      r'''Conectar con seres queridos, tener la capacidad de pedir ayuda y establecer límites saludables siendo asertivos.''',
      r'''Competir constantemente con los compañeros de clase para demostrar superioridad académica.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Porque nos permite tratarnos con amabilidad ante el error o el dolor, alejándonos del autojuicio destructivo y la autocrítica severa.''',
      r'''Porque fomenta que siempre echemos la culpa de nuestros propios errores a los factores ambientales externos.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Ayuda a reducir la generación de cortisol (hormona del estrés) y favorece una mejor regulación de emociones desagradables como la ansiedad.''',
      r'''Aumenta la producción de toxinas en el sistema digestivo, generando la necesidad de consumir alimentos procesados.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Detenerse un momento en el día para realizar una práctica consciente, como respirar profundamente, saborear una bebida o conectarse con el presente.''',
      r'''Abandonar cualquier tipo de interacción física con otras personas para alcanzar la iluminación espiritual en soledad.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''La autorregulación emocional (y la respiración consciente).''',
      r'''El pensamiento abstracto.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Porque permite establecer límites claros cuando algo nos incomoda o afecta, protegiendo nuestra salud emocional sin sentir culpa.''',
      r'''Porque la única forma de ser respetado en la sociedad es negando la ayuda a cualquier persona que la solicite.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''La incapacidad de regular el estrés, generando mayor desgaste físico, irritabilidad emocional y un mayor riesgo a desarrollar enfermedades.''',
      r'''La adquisición de una autoestima invulnerable, pues el individuo aprende a soportar cualquier nivel de maltrato.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''En otorgarnos pequeños premios o palabras de aliento a nosotros mismos tras haber logrado o mantenido un hábito saludable.''',
      r'''En tomar pastillas de vitaminas energéticas para forzar al cuerpo a rendir por encima de sus verdaderas capacidades orgánicas.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''A la confianza en sí mismo y la responsabilidad, adquirida al conocer y comprender reglas dentro de un ambiente justo y consistente.''',
      r'''A la agresividad defensiva que se desarrolla para intimidar a los posibles acosadores escolares antes de que ataquen.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''La aceptación e integración en su medio ambiente mediante actitudes de respeto, cariño y vínculos que lo hacen sentir bienvenido y amado.''',
      r'''La inscripción formal en una escuela de alto rendimiento que garantice el ingreso directo a universidades de prestigio internacional.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Brindando al individuo la capacidad para resolver problemas, buscar alternativas y otorgándole reconocimiento positivo por sus acciones y logros.''',
      r'''Delegando todas las tareas difíciles a los padres o maestros para que ellos resuelvan los obstáculos que el adolescente no desea enfrentar.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''El conocimiento profundo de sí mismo, reconociendo la propia esencia, los valores personales, los intereses y el fortalecimiento del potencial individual.''',
      r'''La copia exacta de la personalidad y los gestos del líder más popular del salón para garantizar la aceptación del grupo de pares en la escuela secundaria.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Proporciona una actitud de esperanza y confianza que permite al individuo soñar, ser visionario y planificar estrategias para alcanzar sus propias metas.''',
      r'''Elimina la capacidad de planificar el futuro, induciendo a la persona a vivir únicamente el presente bajo la filosofía del disfrute inmediato irresponsable.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Permite que el adolescente se diferencie críticamente de los demás, reconociéndose como una persona única con necesidades, metas e intereses propios.''',
      r'''Obliga a los estudiantes a adoptar una postura de aislamiento social radical (ermitaño) para no ser contaminado por los prejuicios culturales de su comunidad.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Porque constituyen categorías axiológicas interdependientes que, al satisfacerse, no solo cubren una falta, sino que operan como potencialidades que garantizan la realización y el bienestar integral de la persona.''',
      r'''Porque son instintos biológicos primitivos compartidos con los animales vertebrados que no tienen ninguna relevancia para la convivencia democrática o la estructuración de la civilización humana.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Promueve que los individuos desarrollen habilidades para reconocer sus derechos, asumir la responsabilidad de proteger su integridad (prevención de adicciones/violencia) y exigir condiciones justas de bienestar.''',
      r'''Exige la creación de prisiones juveniles donde se aísle a cualquier estudiante que consuma comida chatarra para evitar que contamine los buenos hábitos del resto de la comunidad estudiantil.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Trascender la simple ausencia de crisis momentáneas, desarrollando internamente la resiliencia, el equilibrio sistémico y capacidades socioafectivas para transformar pacíficamente las adversidades diarias.''',
      r'''El uso sistemático de medicamentos tranquilizantes y sedantes químicos para silenciar las respuestas naturales del sistema nervioso ante las presiones académicas y laborales.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Una baja autoestima que busca suplir la necesidad de valía personal mediante la complacencia externa, en lugar de priorizar sus propios límites y bienestar (falta de asertividad).''',
      r'''Un exceso de autocompasión que lo lleva a ser extremadamente perezoso, por lo que el cuerpo reacciona produciendo síntomas de fatiga psicosomática para evitar el esfuerzo físico.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Las técnicas de atención plena y respiración consciente activan el sistema nervioso parasimpático, reduciendo el cortisol (estrés crónico), lo que restaura la homeostasis y optimiza el funcionamiento del lóbulo prefrontal para la toma de decisiones y la metacognición.''',
      r'''El aislamiento sensorial total elimina las distracciones externas, permitiendo que la amígdala cerebral tome el control absoluto del comportamiento mediante reacciones instintivas de supervivencia (lucha o huida) sin interferencia de la moralidad.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Que asuma una postura ética sustentada en argumentos razonados, integrando en su reflexión los principios universales, los derechos fundamentales, la dignidad de todas las personas y el análisis de las consecuencias de sus decisiones.''',
      r'''Que delegue toda la responsabilidad de sus juicios a los códigos penales emitidos por el gobierno central, desvinculándose de la toma de decisiones autónomas y evadiendo su responsabilidad cívica frente al bien común de la sociedad local.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Imponen esquemas socioculturales rígidos que limitan la expresión auténtica (por ej. reprimiendo la vulnerabilidad en varones o imponiendo la abnegación total en mujeres), generando conflictos de autoconcepto, disonancias afectivas y legitimando relaciones de dominación.''',
      r'''Facilitan el ingreso de las mujeres a los mercados laborales globales al estandarizar sus comportamientos según los modelos administrativos corporativos diseñados por las grandes transnacionales tecnológicas del hemisferio norte.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Porque el sentido del "Yo" y la propia valía surgen necesariamente de manera diferencial y relacional; se configuran a partir de la interacción discursiva, el reconocimiento, los vínculos y el contraste dialéctico frente al "Otro" (alteridad).''',
      r'''Porque la identidad es un documento impreso que el Estado transfiere al individuo, careciendo de cualquier influencia psicológica interna o desarrollo emocional autónomo a lo largo del tiempo de vida útil del sujeto.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''A una pobreza de Entendimiento, Afecto y Protección, generada por dinámicas institucionales y culturales que niegan al sujeto un entorno seguro, la validación de sus emociones y las herramientas democráticas para la resolución de conflictos.''',
      r'''A una pobreza de Ocio comercial, producto de las restricciones gubernamentales que prohíben la construcción de grandes centros comerciales y complejos de entretenimiento cinematográfico cerca de las zonas escolares urbanas.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''La toma de conciencia crítica y el control sobre sus propios procesos de pensamiento y aprendizaje (aprender a aprender, a pensar y a evaluarse), permitiéndole autorregularse, superar errores y forjar autonomía intelectual.''',
      r'''La habilidad de memorizar enciclopedias históricas completas mediante técnicas de repetición fonética acelerada para aprobar exámenes estandarizados internacionales sin comprender el significado de los textos leídos.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Movilizan la empatía cognitiva y afectiva al exigir que el estudiante se descentre de su visión egocéntrica para "habitar" la posición del otro, ensayando respuestas éticas, pacíficas y regulando sus reacciones ante el conflicto de manera experiencial.''',
      r'''Obligan a los alumnos más tímidos a sufrir ataques de pánico controlados en el escenario frente a sus pares, como una terapia de choque extremo diseñada para curar rápidamente los trastornos de ansiedad fóbica social severa y persistente.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''A través de símbolos, lenguaje, narrativas históricas excluyentes y estereotipos que legitiman y normalizan la superioridad de ciertos grupos y la inferioridad o invisibilización de otros, erosionando la identidad y autovaloración de los marginados.''',
      r'''Mediante el desvío de los recursos hídricos y alimenticios de las comunidades rurales hacia las grandes metrópolis industriales, provocando hambrunas y desnutrición severa que altera el crecimiento cerebral de los recién nacidos genéticamente.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Que no basta con evadir las drogas o el conflicto manifiesto (ausencia de violencia); se requiere una participación proactiva, desarrollo de habilidades sociales, comunicación asertiva, democratización de las normas y una construcción activa del bien común y la equidad.''',
      r'''Que la única prevención válida es el aislamiento físico total de la escuela respecto a la comunidad circundante, construyendo muros infranqueables que impidan el paso de los vicios y la corrupción inherente a la vida urbana caótica y desordenada actual.''',
  ...
  Question(
    ...
    options: [
      ...
      r'''Es el sistema de creencias que el estudiante tiene sobre su autoeficacia (capacidad de aprender), el valor que atribuye a la tarea y los sentimientos de satisfacción y agencia que surgen al gestionar exitosamente sus metas académicas.''',
      r'''Constituye el instinto biológico primario y ciego de competir para derrotar a los compañeros más débiles en los exámenes, elevando la autoestima exclusivamente a través de la humillación del prójimo en contextos de evaluación sumativa formal.''',
