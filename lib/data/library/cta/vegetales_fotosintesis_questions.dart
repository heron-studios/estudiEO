...
final List<Question> vegetalesFotosintesisQuestions = [
  // Nivel Fácil
  Question(
    id: "veg_fot_f1",
    topicId: "cta_vegetales_fotosintesis",
    text: r"""¿Qué es fundamentalmente la fotosíntesis?""",
    options: [
      r"""La forma en que las plantas absorben oxígeno en la noche.""",
      r"""El proceso en el cual la energía de la luz se convierte en energía química en forma de azúcares.""",
      r"""La destrucción de moléculas de glucosa para generar calor.""",
      r"""La absorción de agua a través de los poros de las hojas.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Ácido abscísico, clorofila y helio.""",
      r"""Dióxido de carbono, agua y energía de la luz del sol.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""La fabrican internamente combinando oxígeno e hidrógeno.""",
      r"""La absorben de la humedad de otras plantas cercanas.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Porque introduce energía química y carbono fijo en los ecosistemas formando la base de la cadena alimentaria, además de producir oxígeno respirable.""",
      r"""Porque evita que las plantas crezcan demasiado y consuman todo el agua.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Fase luminosa y fase oscura (o ciclo de Calvin).""",
      r"""Fase aerobia y fase anaerobia.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""En la pared celular.""",
      r"""En el estroma (el espacio lleno de líquido que rodea a los tilacoides).""",
  ...
  Question(
    ...
    options: [
      ...
      r"""ATP y NADPH.""",
      r"""Dióxido de carbono y Glucosa.""",
      r"""Helio y Nitrógeno.""",
    ],
    correctAnswer: 2,
  ...
  Question(
    id: "veg_fot_m5",
    topicId: "cta_vegetales_fotosintesis",
    text: r"""¿Qué ocurre durante la fase oscura (ciclo de Calvin)?""",
    options: [
      r"""La planta absorbe energía solar y rompe el agua.""",
      r"""Se libera oxígeno molecular al aire.""",
      r"""Se utiliza el ATP y el NADPH para fijar el dióxido de carbono y producir azúcares de tres carbonos que formarán glucosa.""",
      r"""La clorofila pierde su color verde.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Aumenta la acidez de los océanos.""",
      r"""Retira grandes cantidades de dióxido de carbono de la atmósfera, ayudando a mitigar el efecto invernadero y el calentamiento global.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Empieza a producir dióxido de carbono en lugar de absorberlo.""",
      r"""Su eficiencia disminuye por la reducción de luz y temperatura, aumentando el ácido abscísico y reduciendo la clorofila, lo que cambia el color de las hojas.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Cierra sus estomas para evitar la pérdida de agua por transpiración, lo que impide la entrada de CO2 y hace que la actividad fotosintética disminuya.""",
      r"""Absorbe el agua almacenada en su núcleo celular ignorando el CO2.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""La contaminación lumínica nocturna.""",
      r"""La temperatura, ya que existe un nivel óptimo superado el cual las enzimas pueden desnaturalizarse.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Son micoheterótrofas, dependen de una relación simbiótica con hongos que les proporcionan los nutrientes necesarios.""",
      r"""Absorben glucosa de la lluvia.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Un orgánulo celular paralelo al cloroplasto exclusivo de algas.""",
      r"""La enzima encargada de degradar la glucosa.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""A través de la fotólisis del agua, un proceso donde el agua se rompe liberando protones, electrones (que repusieron el hueco) y gas oxígeno.""",
      r"""Absorbiendo un fotón infrarrojo.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Genera exclusivamente NADPH para el ciclo de Calvin.""",
      r"""Solo interviene el Fotosistema I, los electrones retornan y solo se produce ATP, sin realizarse fotólisis del agua ni desprender oxígeno o NADPH.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Los protones se bombean al interior del tilacoide y, al regresar al estroma a través de las ATPasas, liberan energía catalizando la síntesis de ATP.""",
      r"""Unir directamente el CO2 a la glucosa.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Son procesos químicamente opuestos: la fotosíntesis es anabólica, consume energía y CO2, mientras que la respiración es catabólica, libera energía y consume O2.""",
      r"""Ambas ocurren exclusivamente en los cloroplastos.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Convierte al cloroplasto en una mitocondria.""",
      r"""Baja el rendimiento fotosintético debido a que induce el proceso ineficiente de la fotorrespiración.""",
  ...
  Question(
    id: "veg_fot_d7",
    topicId: "cta_vegetales_fotosintesis",
    text: r"""¿Qué papel juegan las granas en la anatomía del cloroplasto?""",
    options: [
      r"""Son conductos por donde entra el dióxido de carbono.""",
      r"""Son cristales de azúcar solidificado.""",
      r"""Es el fluido acuoso donde se asienta el ADN vegetal.""",
      r"""Son las pilas de sacos aplanados llamados tilacoides que se asemejan a panqueques, donde se alojan los pigmentos.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Liberaron poco a poco oxígeno como subproducto en una atmósfera que carecía de él, permitiendo la posterior evolución de las formas de vida aerobias.""",
      r"""Crearon la materia oscura del universo.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Infrarrojos y ultravioletas puros.""",
      r"""1000 nm en ambos.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""De la Glucosa (C6H12O6).""",
      r"""Del ATP hidrolizado.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Al ATP directamente.""",
      r"""Al una molécula de 5 átomos de carbono llamada Ribulosa-1,5-difosfato.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Oxidan glucosa convirtiéndola en piruvato.""",
      r"""Oxidan azufre puro reduciéndolo a sulfato.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Acetil-CoA.""",
      r"""Dióxido de carbono condensado.""",
      r"""Oxalacetato.""",
    ],
    correctAnswer: 1,
  ...
  Question(
    ...
    options: [
      ...
      r"""Existe un flujo lineal y abierto donde los electrones salen del agua, transitan por PS II y PS I, y terminan reduciendo de manera definitiva al NADP+ a NADPH.""",
      r"""Únicamente se produce ATP sin intervención de ningún aceptor de electrones.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Capturar luz infrarroja profunda para las raíces.""",
      r"""Convertir el hierro en oxígeno.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Átomos de carbono hacia la membrana.""",
      r"""Se están bombeando protones (H+) desde el estroma hacia el interior (lumen) del tilacoide.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""En la síntesis de glucosa a partir de precursores que no son glúcidos, como el oxalacetato o el piruvato.""",
      r"""En la fijación del nitrógeno atmosférico para crear glucosa.""",
  ...
  Question(
    ...
    options: [
      ...
      r"""Ambas generan exactamente la misma cantidad de calor disipado.""",
      r"""Porque la fotosíntesis ocurre en animales y la respiración en plantas.""",
