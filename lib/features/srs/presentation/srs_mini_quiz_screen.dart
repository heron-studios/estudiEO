...
class _SrsMiniQuizScreenState extends State<SrsMiniQuizScreen> {
  ...
  void _finishMiniQuiz() {
    ...
    Navigator.pop(context, passed); // Return to SrsReviewScreen with pass/fail status
  }
  ...
  Widget build(BuildContext context) {
    if (_questions.isEmpty) {
      return Scaffold(
        ...
        body: const Center(child: Text('Error: No hay preguntas para el quiz', style: TextStyle(color: _text))),
      );
    }
                    ...
                    ...List.generate(question.options.length, (index) {
                      ...
                      return Padding(
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            onTap: isAnswered ? null : () => _answerQuestion(question.id, index, question.correctAnswer),
                            borderRadius: BorderRadius.circular(14),
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  Text(String.fromCharCode(65 + index), style: TextStyle(color: border, fontWeight: FontWeight.bold)),
                                  const SizedBox(width: 16),
                                  Expanded(child: Text(question.options[index], style: const TextStyle(color: _text))),
                                ],
                              ),
                            ),
                          ),
          ...
          child: ConstrainedBox(
            ...
            child: Padding(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                Text(
                  passed ? 'Resultados del Mini-Quiz' : 'Mini-Quiz No Aprobado',
                        ...
                        children: [
                          ...
                          Switch(
                            ...
                            onChanged: (val) {
                              ...
                              context.read<LocalStorageService>().saveStrictMode(val);
                            },
                          ),
                        ],
                      ),
