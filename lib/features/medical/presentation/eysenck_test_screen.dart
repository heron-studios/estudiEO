...
class _EysenckTestScreenState extends State<EysenckTestScreen> {
  final List<EysenckQuestion> _questions = [
    EysenckQuestion(
      ...
      false,
      'Mal: Indica inestabilidad emocional, impulsividad o bajo control de impulsos.',
    ),
    EysenckQuestion(
    ...
    EysenckQuestion(
      ...
      true,
      'Bien: Indica estabilidad emocional, disciplina o nivel adecuado de sociabilidad.',
    ),
    EysenckQuestion(
