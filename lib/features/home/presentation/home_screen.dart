        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              // ── BANNER GENERADOR DE FLASHCARDS IA ──────────────────────
              FadeTransition(
                opacity: _fabAnimation,
                child: Padding(
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: const Text('EXPERIMENTAL', style: TextStyle(color: Colors.white, fontSize: 8, fontWeight: FontWeight.bold)),
                                      ),
                                    ],
                                  ),
                                  const SizedBox(height: 4),
                                  const Text(
                                    'Crea tarjetas de memoria desde cualquier texto',
                                    style: TextStyle(
                                      color: Colors.white70,
                                      fontSize: 13,
                                    ),
